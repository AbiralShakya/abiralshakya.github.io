...
\hypersetup{
    ...
    filecolor=magenta,
    urlcolor=cyan,
    pdftitle={On Scaling Modern Models on Modern Hardware},
    pdfpagemode=FullScreen,
}

\title{On Scaling Modern Models on Modern Hardware}
...
\begin{align*}
C_\text{max} &\approx 1979 \, \text{TFLOPs (FP16)} \\
B_\text{max} &\approx 3.35 \, \text{TB/s}
\end{align*}
...
\begin{itemize}
\item 0.6B model: $\sim$3.5 GB
\item 4B model: $\sim$4.2 GB
\item 14B model: $\sim$6.3 GB
\item 32B model: $\sim$8.1 GB
\end{itemize}
